...
int high,width;//游戏区域大小
int bar_left,bar_right;//挡板左右坐标
int bar_x;
int gameover_flag;//让小球二个循环移动一次,增加挡板速度。 
int num_hit,num_eat;
int brick[100][100];
int times=0;
int main() 
...
void change()
{
 ...
 void gameover()
 {
	...
	y=y+2;
	gotoxy(5,y);
	printf("接住球：%d次",num_hit);
	y=y+2;
	gotoxy(5,y);
	printf("消砖块：%d次",num_eat);
		getch(); 
 }
 void msg()
 {
